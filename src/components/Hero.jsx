        ...
        <section className="hero-background py-56 relative">
            ...
            <div className="flex mx-8">
                <div className="flex-auto w-full md:w-2/3 container mx-8 relative z-10 text-left text-white">
                    ...
                    <p className="mt-4 text-xl">Kendi Güvenli Ortamınızda İstediğiniz Zaman Online Terapi Alın</p>
                    <div className="w-fit mt-10 text-center space-y-4 bg-blue-950 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-900"> <a href="#" className="">
