...
const AboutCallToAction = () => {
    return (
        <section className="py-16 bg-blue-950 px-6 text-white text-center">
            ...
            <Link onClick={() => { window.scroll(0, 0); }} to="/contact" className="transition-colors duration-500 mt-8 inline-block bg-white text-blue-950 px-8 py-3 rounded-lg hover:bg-gray-300">Book Appointment</Link>
        </section>
    )
}
