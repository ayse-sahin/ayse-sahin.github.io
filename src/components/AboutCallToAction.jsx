...
const AboutCallToAction = () => {
    ...
    return (
        <section style={style} className="py-20 px-6 text-light text-center">
            ...
            <Link onClick={() => { window.scroll(0, 0); }} to="/contact" className="transition-colors font-bold duration-500 mt-8 inline-block bg-light text-darker px-8 py-3 rounded-lg hover:bg-link-hover hover:text-light">Randevu Oluştur</Link>
        </section>
    )
}
