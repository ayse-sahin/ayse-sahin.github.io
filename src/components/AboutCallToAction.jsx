...
const AboutCallToAction = () => {
    return (
        <section className="py-16 bg-indigo-600 px-6 text-white text-center">
            ...
            <a href="#" className="mt-8 inline-block bg-white text-indigo-600 px-8 py-3 rounded-lg hover:bg-gray-100">Book Appointment</a>
        </section>
    )
}
